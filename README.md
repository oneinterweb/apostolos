...
3. За автор на картата след статията използвайте `Георги Бакалов` или `Иво Орешков`.
4. Сложете оригиналните картинки в `assets/uploads/ГГГГ/ММ/`, по същата схема като стария `wp-content/uploads`.
5. Commit и push към `main`. Actions прави build и публикува сайта.
